...
# Tangram Refill Style (No Labels)
...
1. Update your copy of the scene file on [line 428](https://github.com/tangrams/refill-style-no-labels/blob/gh-pages/refill-style-no-labels.yaml#L428) to reference the API key you created in Step 3 in the **Sign up** section above. 
